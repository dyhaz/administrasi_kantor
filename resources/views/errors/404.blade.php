...
<head>
    ...
    <!-- Login -->
    <link href="/theme/assets/css/error.css" rel="stylesheet" type="text/css" />
...
<div class="actions">
    <div class="list-group">
        ...
        <a href="/home" class="list-group-item"><i class="icon-home"></i> Go to Dashboard <i class="icon-angle-right align-right"></i></a>
        <a href="{{ route('contact') }}" class="list-group-item"><i class="icon-question"></i> Support <i class="icon-angle-right align-right"></i></a>
        <a href="{{ route('contact') }}" class="list-group-item"><i class="icon-phone"></i> Call us <i class="icon-angle-right align-right"></i> <span class="badge">021-215-584</span></a>
    </div>
</div>

<!-- Footer -->
<div class="footer">
    Melon - Flat &amp; Responsive Admin Template<br>&copy; 2017
</div>
<!-- /Footer -->
</body>
</html>