<div class="form-group {{ $errors->has('nomor') ? 'has-error' : ''}}">
    ...
    <div class="col-md-6">
        ...
        {!! Form::text('search_text_kegiatan_surat', null, ['class' => 'form-control', 'placeholder' => 'Search Text', 'id' => 'search_text_kegiatan_surat']) !!}
    ...
    <script type="text/javascript">
        ...
        $('#search_text_kegiatan_surat').typeahead({
            template: function(data){
                return '<strong>No: </strong>'+data.nomor+'</br><strong>Masalah: </strong>'+data.klasifikasi_arsip+'</br><strong>Kegiatan: </strong>'+data.kegiatan;
            },
            remote:  {
                url: url2,
                filter: function (data) {
                    ...
                    return $.map(data, function (data) {
                        return {
                            ...
                            id: data.id,
                            nomor: data.nomor,
                            klasifikasi_arsip: data.klasifikasi_arsip,
            ...
            //$('#search_text_kegiatan_surat').val(datum.name);
            //$('#search_text_kegiatan_surat').typeahead('val', datum.name);
        });
